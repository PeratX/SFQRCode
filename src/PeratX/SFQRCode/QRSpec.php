...
class QRSpec{
	...
	public static function getDataLength($version, $level){
		return self::$capacity[$version][SFQRCode::QRCAP_WORDS] - self::$capacity[$version][SFQRCode::QRCAP_EC][$level];
	}

	public static function getECCLength($version, $level){
		return self::$capacity[$version][SFQRCode::QRCAP_EC][$level];
	}

	public static function getWidth($version){
		return self::$capacity[$version][SFQRCode::QRCAP_WIDTH];
	}

	public static function getRemainder($version){
		return self::$capacity[$version][SFQRCode::QRCAP_REMINDER];
	}

	public static function getMinimumVersion($size, $level){

		for($i = 1; $i <= SFQRCode::QRSPEC_VERSION_MAX; $i++){
			$words = self::$capacity[$i][SFQRCode::QRCAP_WORDS] - self::$capacity[$i][SFQRCode::QRCAP_EC][$level];
			if($words >= $size)
				return $i;
		}
	...
	public static function lengthIndicator($mode, $version){
		if($mode == SFQRCode::QR_MODE_STRUCTURE)
			return 0;
	...
	// size: [SFQRCode::QRSPEC_VERSION_MAX - 6]
	...
	public static function getVersionPattern($version){
		if($version < 7 || $version > SFQRCode::QRSPEC_VERSION_MAX)
			return 0;
	...
	public static function createFrame($version){
		$width = self::$capacity[$version][SFQRCode::QRCAP_WIDTH];
