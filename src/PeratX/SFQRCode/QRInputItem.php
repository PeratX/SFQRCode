...
class QRInputItem{
	...
	public function encodeModeNum($version){
		try{
			...
			$val = 0x1;
			$bs->appendNum(4, $val);
			$bs->appendNum(QRSpec::lengthIndicator(SFQRCode::QR_MODE_NUM, $version), $this->size);
	...
	public function encodeModeAn($version){
		try{
			...
			$bs->appendNum(4, 0x02);
			$bs->appendNum(QRSpec::lengthIndicator(SFQRCode::QR_MODE_AN, $version), $this->size);
	...
	public function encodeMode8($version){
		try{
			...
			$bs->appendNum(4, 0x4);
			$bs->appendNum(QRSpec::lengthIndicator(SFQRCode::QR_MODE_8, $version), $this->size);
	...
	public function encodeModeKanji($version){
		try{
			...
			$bs->appendNum(4, 0x8);
			$bs->appendNum(QRSpec::lengthIndicator(SFQRCode::QR_MODE_KANJI, $version), (int) ($this->size / 2));
	...
	public function estimateBitStreamSizeOfEntry($version){
		...
		switch($this->mode){
			...
			case SFQRCode::QR_MODE_STRUCTURE:
				return SFQRCode::STRUCTURE_HEADER_BITS;
			default:
				return 0;
		}
